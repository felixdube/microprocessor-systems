...
\section{Conclusion}
The RTOS operating system allowed the system to concurrently sample the CPU temperature, sample the accelerometer, display some value on the 7-segment display, and poll the keypad for user input. As the results suggest all the features could be done at specific frequency without a thread affecting other threads functionalities.
